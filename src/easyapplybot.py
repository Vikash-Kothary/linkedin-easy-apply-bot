...
class EasyApplyBot:
    ...
    def __init__(
        ...
        chrome_driver_path = "/home/vikash/.wdm/drivers/chromedriver/linux64/132.0.6834.159/chromedriver-linux64/chromedriver"
        ...
        self.qa_file = Path("files/data/qa.csv")
        self.answers = {}
    ...
    def start_linkedin(self, username, password) -> None:
        ...
        try:
            ...
            login_button = self.browser.find_element(
                "xpath", '//*[@id="organic-div"]/form/div[4]/button'
            )
                ...
                if self.is_present(self.locator["links"]):
                    ...
                    for link in links:
                        if "Applied" not in link.text:  # checking if applied already
                            if (
                                link.text not in self.blacklist
            ...
            if self.is_present(self.locator["radio_select"]):
                try:
                    input = field.find_element(
                        By.CSS_SELECTOR, "input[type='radio'][value={}]".format(answer)
                    )
